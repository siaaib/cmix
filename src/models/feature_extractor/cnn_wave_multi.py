...
class WaveNetSpectrogram(nn.Module):
    def __init__(
        ...
        if isinstance(wave_layers, int):
            wave_layers = tuple([wave_layers])
...
class WaveNetSpectrogramMulti(nn.Module):
    def __init__(
        self,
        in_channels: int = 3,
        base_filters: int | tuple = 16,
        wave_layers: tuple = (2, 1),
        wave_block: str = "simplified",
        kernel_sizes: int = (3, 5, 7, 11, 15),
        downsample: int = 2,
        sigmoid: bool = False,
        output_size: int = None,
        separate_channel: bool = False,
        ...
        self.wave_blocks = nn.ModuleList([WaveNetSpectrogram(
                        in_channels=in_channels,
                        base_filters=base_filters,
                        wave_layers=wave_layer,
                    ...
                    for wave_layer in wave_layers for kernel_size in kernel_sizes])
